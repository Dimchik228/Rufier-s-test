...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        line1 = ColoredLayout(lcolor = (0, 55, 0.25, 5))
        vlay = ColoredLayout(orientation='vertical', lcolor = (0.94, 0.54, 0.04, 2))
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        ...
        self.run = Runner(total=30, steptime=1.5, size_hint=(0.4, 1), lcolor = (0.64, 0.74, 0.75, 1))
